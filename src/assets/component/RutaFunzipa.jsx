...
function RutaFunzipa() {
  useEffect(() => {
    const start = async () => {
      document.getElementById("spinner").style.display = "block";
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        container: document.querySelector("#ar-conteiner"),
        // URL de Cloudinary para el archivo .mind del Capítulo 5
        imageTargetSrc: 'https://res.cloudinary.com/dcpgesnzc/raw/upload/v1774737824/capitulo5.mind',
      });
      ...
      const loadAndShowVideo = async (videoUrl) => {
        ...
        // OnTargetLost vacío para mantener la continuidad del audio y video
        anchor.onTargetLost = () => {};
      ...
      const createVideoSelectionButtons = () => {
        ...
        buttonSpanish.addEventListener('click', () => {
          // URL del video de Cloudinary para el Capítulo 5
          loadAndShowVideo('https://res.cloudinary.com/dcpgesnzc/video/upload/v1774736862/xw8ah74y6pxelgyj0i8t.mp4'); 
