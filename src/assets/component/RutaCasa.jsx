  ...
  useEffect(() => {
    const start = async () => {
      ...
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        ...
        imageTargetSrc: '/images/capitulo2.mind',
      });
      ...
      const createVideoSelectionButtons = () => {
        ...
        buttonSpanish.addEventListener('click', () => {
          loadAndShowVideo('/videos/capitulo2ns.mp4'); // Cargar video en español
        ...
        buttonEnglish.addEventListener('click', () => {
          loadAndShowVideo('/videos/capitulo2ns.mp4'); // Cargar video en inglés
          adjustContainerStyle(); // Ajustar estilos del contenedor
        });
