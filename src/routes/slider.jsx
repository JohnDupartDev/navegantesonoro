                    ...
                    <div className="card text-white">
                      ...
                      <div className="card-body">
                        ...
                        <Link to="https://navegantesonoro.com/estaciondeltren" className="btn btn-outline-warning"> 
                          Escuchar <img src={`${cloudPath}audio.svg`} style={{ width: '20px', height: '20px', marginLeft: '0.5rem' }} alt="Icono" />
                        </Link>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="card text-white">
                      ...
                      <div className="card-body">
                        ...
                        <Link to="https://navegantesonoro.com/comprar" className="btn btn-outline-warning">
                          Comprar<img src={`${cloudPath}dinero.png`} style={{ width: '20px', height: '20px', marginLeft: '0.5rem' }} alt="Icono" />
                        </Link>
                      </div>
                    </div>
                  </div>
